...
public partial class MainForm : Form
{
    ...
    private void AddServiceCheck(WindowsServiceInfo? serviceInfo)
    {
    ...
    {
        var selected = GetSelected<WindowsServiceInfo>(_availableServicesGrid);
        if (selected is null)
        {
    ...
    private string GetSelectedServiceName()
    {
        ...
        var available = GetSelected<WindowsServiceInfo>(_availableServicesGrid);
    ...
    private static string GetGridRowKey(DataGridViewRow row)
    {
        return row.Tag switch
        {
            ...
            WindowsServiceInfo serviceInfo => "LocalService:" + serviceInfo.ServiceName,
            _ => ""
        };
    }
