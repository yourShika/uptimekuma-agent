...
public static class I18n
{
    ...
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["Übersicht"] = "Overview",
        ["Monitore"] = "Monitors",
        ["Ø Antwort"] = "Avg response",
        ["Suchen"] = "Search",
        ["Aktuelle Monitore"] = "Current monitors",
        ["Erreichbarkeit lokaler Hosts"] = "Reachability of local hosts",
        ["Offene Ports und Endpunkte"] = "Open ports and endpoints",
        ["Status der überwachten Dienste"] = "Status of monitored services",
        ["Speicher und Mountpoints"] = "Storage and mountpoints",
        ["Ereignisprotokoll des Agents"] = "Agent event log",
        ["Globale Konfiguration und Watchdog"] = "Global configuration and watchdog",
        ["Alle Monitore auf einen Blick"] = "All monitors at a glance",
        ["Ping"] = "Ping",
        ["TCP"] = "TCP",
        ["Dienst"] = "Service",
        ["Laufwerk"] = "Drive",
    ...
    private static readonly IReadOnlyDictionary<string, string> Polish = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["Übersicht"] = "Przegląd",
        ["Monitore"] = "Monitory",
        ["Ø Antwort"] = "Śr. odpowiedź",
        ["Suchen"] = "Szukaj",
        ["Aktuelle Monitore"] = "Bieżące monitory",
        ["Erreichbarkeit lokaler Hosts"] = "Dostępność lokalnych hostów",
        ["Offene Ports und Endpunkte"] = "Otwarte porty i punkty końcowe",
        ["Status der überwachten Dienste"] = "Status monitorowanych usług",
        ["Speicher und Mountpoints"] = "Pamięć i punkty montowania",
        ["Ereignisprotokoll des Agents"] = "Dziennik zdarzeń agenta",
        ["Globale Konfiguration und Watchdog"] = "Konfiguracja globalna i watchdog",
        ["Alle Monitore auf einen Blick"] = "Wszystkie monitory w jednym widoku",
        ["Ping"] = "Ping",
        ["TCP"] = "TCP",
        ["Dienst"] = "Usługa",
        ["Laufwerk"] = "Dysk",
